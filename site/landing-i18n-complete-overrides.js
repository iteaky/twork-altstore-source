(() => {
  ...
  // Proper nouns and compact demo labels still need a language-specific form,
  // otherwise the completeness test correctly identifies them as English fallbacks.
  const fixes = {
    cs: {
